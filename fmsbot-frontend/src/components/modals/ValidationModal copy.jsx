      ...
      <div style={modalOverlayStyle} onClick={onClose}>
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '14px', borderTop: `1px solid ${activeTheme.border}`, paddingTop: '20px' }}>
            <button onClick={onClose} className="btn-h" style={cancelBtnStyle(activeTheme)}>
              CANCEL
            </button>
            <button 
              onClick={onSubmit} 
              ...
              style={{ 
                ...
                boxShadow: `0 4px 14px ${activeTheme.accent}44`
              }}
            >
              SUBMIT VALIDATION
            </button>
...
const PhotoSection = ({ title, isMatch, imgSrc, activeTheme, getImageUrl, onZoom }) => {
  ...
  return (
    ...
    >
      ...
      {/* Global CSS Injector Tanpa :has() - Mencegah Lag Rendering */}
      <style>{`
        .img-box-container {
