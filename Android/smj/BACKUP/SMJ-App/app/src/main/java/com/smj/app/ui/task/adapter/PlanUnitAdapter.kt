...
class PlanUnitAdapter(
    mContext: Context,
    mData: ArrayList<PlanUnit>,
    adapterCallback: PlanUnitAdapterCallback
) : RecyclerView.Adapter<PlanUnitAdapter.MyViewHolder>()  {

    private var mContext: Context
    private var mData: ArrayList<PlanUnit>
    private val mAdapterCallback: PlanUnitAdapterCallback
    ...
    override fun onBindViewHolder(holder: PlanUnitAdapter.MyViewHolder, position: Int) {
        val data = mData[position]
        holder.tvUnit.text = data.getUnitCode()
        holder.tvSopir.text = Html.fromHtml("<i>Sopir: "+data.getSopir()+"</i>")
    }
    ...
    interface PlanUnitAdapterCallback {
