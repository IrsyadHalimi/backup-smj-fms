...
class ContactAdapter(
    ...
    private fun checkUserCurrent(bindingAdapterPosition: Int, job: String?, forUse: String?) {
        ...
        if (positionCurrent == "root" || positionCurrent == "ADMIN" || positionCurrent == "ADMIN HR") {
            ...
            usersRefrence.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    if (p0.exists()) {
                        ...
                        if (planTask?.getStatus() == "todo" || planTask?.getStatus() == "doing") {
            ...
            usersRefrence.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    if (p0.exists()) {
                        ...
                        if (planTask2?.getStatus() == "todo" || planTask2?.getStatus() == "doing") {
                            val alertBuilder = android.app.AlertDialog.Builder(mContext)
                            alertBuilder.setIcon(R.drawable.ic_worker)
                            alertBuilder.setTitle(HtmlCompat.fromHtml(" <strong>"+planTask2.getPengawasName()+"</strong>", HtmlCompat.FROM_HTML_MODE_LEGACY))
            ...
            usersRefrence.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    if (p0.exists()) {
                        ...
                        for (dataSnapshot in p0.children) {
                            planUnit = dataSnapshot.getValue(PlanUnit::class.java)
                        }
