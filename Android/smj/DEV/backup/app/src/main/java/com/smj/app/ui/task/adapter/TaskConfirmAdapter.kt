...
class TaskConfirmAdapter(
    mContext: Context,
    mData: ArrayList<TaskGroupList>,
    adapterCallback: TaskConfirmAdapterCallback
) : RecyclerView.Adapter<TaskConfirmAdapter.MyViewHolder>()  {

    private var mContext: Context
    private var mData: ArrayList<TaskGroupList>
    private val mAdapterCallback: TaskConfirmAdapterCallback
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TaskConfirmAdapter.MyViewHolder {
        val v: View =
            LayoutInflater.from(mContext).inflate(R.layout.layout_item_task, parent, false)
        return MyViewHolder(v)
    }

    override fun onBindViewHolder(holder: TaskConfirmAdapter.MyViewHolder, position: Int) {
...
//        }
    ...
    interface TaskConfirmAdapterCallback {
        fun onDetail(bindingAdapterPosition: Int, mData: java.util.ArrayList<TaskGroupList>)
