...
import com.smj.app.databinding.ActivityGalianListBinding
...
class GalianListActivity : AppCompatActivity(), LocationAdapter.LocationAdapterCallback {
    private lateinit var binding: ActivityGalianListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGalianListBinding.inflate(layoutInflater)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(snapshot.exists()){
                    ...
                    val locationAdapter = LocationAdapter(
                        this@GalianListActivity,
                        locationList!!,
                        this@GalianListActivity,
                        position
                    )
                    recyclerViewLocation.layoutManager = LinearLayoutManager(this@GalianListActivity)
